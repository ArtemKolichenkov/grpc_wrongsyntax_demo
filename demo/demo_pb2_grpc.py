...
class DemoStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/demo.Demo/SayHello',
                request_serializer=demo__pb2.Userinfo.SerializeToString,
...
def add_DemoServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,
                    request_deserializer=demo__pb2.Userinfo.FromString,
...
class Demo(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/demo.Demo/SayHello',
            demo__pb2.Userinfo.SerializeToString,
            demo__pb2.Greeting.FromString,
